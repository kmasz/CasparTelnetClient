...
def main():
    ...
    if tn != None:
        ...
        #tn_write(tn, CasparMixerCommands(1,layer=0,min_input=0,max_input=1,min_output=0,max_output=1,gamma=1,duration = '').mixerLevels())
        ...
        #tn_write(tn, CasparMixerCommands(1,layer=0, volume=1,duration = 50).mixerVolume())
        #print(CasparMixerCommands(1,layer=0).mixerFill())
        #tn_write(tn, CasparMixerCommands(1,layer=0,mastervolume=1).mixerMastervolume())
        #tn_write(tn, CasparMixerCommands(1,layer=0,straightalphaoutput=0).mixerStraight_alpha_output())
        ...
        #print(CasparMixerCommands(1,layer=0).get_variable2("layer"))
        tn_read(tn)
        tn_close(tn)
    else:
